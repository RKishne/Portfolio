...
import aboutImage from "../../public/images/main_image.webp";
...
const Marker = styled(motion.div)<{ $align: "left" | "right" }>`
  ...
  ${(props) =>
    props.$align === "left"
      ? "right: -10px;"
      : "left: -10px;"} /* -8px for perfect center + border adj */
...
const timelineData = [
  {
    ...
    role: "Self-Employed",
    description:
      "Working as a freelance developer while continuously learning and implementing advanced technologies. Building scalable MERN and Shopify applications, exploring system design, and improving performance-focused development skills.",
    tags: ["Freelancing", "Advanced Tech", "MERN", "Shopify"],
  },
  {
    year: "2024 - 2026",
    title: "Shopify Full-Stack Developer",
    role: "Itgeeks Technologies Pvt. Ltd",
    description:
      "Developing and customizing high-performance Shopify stores using Liquid, APIs, and modern frontend tools. Built 5+ stores from scratch and contributed to 20+ client projects with scalable solutions.",
    tags: ["Shopify", "Liquid", "API Integration", "Full-Stack"],
  },
  {
    year: "2023",
    title: "Web Development Internship",
    role: "Exposy Data Labs",
    description:
      "Gained hands-on experience in real-world development including debugging, API creation, and system-level problem solving with OOP concepts.",
    tags: ["OOP", "API Development", "Debugging", "System Design"],
  },
  {
    year: "2018 - 2022",
    title: "B.Tech in Computer Science",
    role: "IPS Academy, Indore",
    description:
      "Completed Bachelor of Technology with a strong foundation in programming, database design, and problem-solving skills.",
    tags: ["Computer Science", "DB Design", "Programming", "Logic"],
  },
];
// Skills Data
const skillsData = [
      ...
      <AboutHero>
        <Container>
          <motion.div
            ...
            animate="visible"
          >
            <HeroTitle variants={itemVariants}>About Me</HeroTitle>
            <HeroSubtitle variants={itemVariants}>
              I'm Rahul kishne (RK is my handle), an aspiring software engineer
              and freelancer from Madhya Pradesh, India. I'm passionate about
              creating innovative, functional, and visually appealing digital
            ...
            <AboutImageSection variants={itemVariants}>
              <AboutImageContainer>
                <AboutImage
                  src={aboutImage}
                  alt="About Rahul kishne (Rahul RNR)"
                />
              </AboutImageContainer>
            </AboutImageSection>
          </motion.div>
